...
class Category(SQLModel, table=True):
    ...
    materials: list["Material"] = Relationship(back_populates="category")
...
# ──────────────────────────────────────────────
# Material — arquivos e links taggeados
# ──────────────────────────────────────────────
...
class Material(SQLModel, table=True):
    ...
    title: str
    type: MaterialType
    path: Optional[str] = None    # arquivo local em /data/documents
    url: Optional[str] = None     # link externo
    ...
    # Relationships
    category: Optional[Category] = Relationship(back_populates="materials")
